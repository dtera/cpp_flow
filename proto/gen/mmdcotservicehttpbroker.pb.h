...
public:
  ...
  static bool ValidateKey(std::string* s) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
       s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "otServicePB.OTClientResult.ResMapEntry.key");
#else
    (void) s;
#endif
    return true;
...
#ifndef NDEBUG
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
       s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "otServicePB.OTClientResult.ResMapEntry.value");
#else
    (void) s;
#endif
    return true;
...
class OTClientResult final :
 ...
 public:
  ...
  OTClientResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline std::string* OTServerRequest::release_sessiontoken() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = sessiontoken_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (sessiontoken_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
