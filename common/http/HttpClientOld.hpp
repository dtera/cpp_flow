...
class HttpClientOld {
public:
    explicit HttpClientOld(const int port = 80, const std::string &host = "localhost", std::string http_version = "1.1")
    ...
    void get(const std::string &path) {
        ...
        resolver_.async_resolve(query,
                                boost::bind(&HttpClientOld::handle_resolve, this,
...
private:
    ...
    void handle_resolve(const boost::system::error_code &err,
        ...
        if (!err) {
            ...
            boost::asio::async_connect(socket_, endpoints,
                                       boost::bind(&HttpClientOld::handle_connect, this,
                                                   boost::asio::placeholders::error));
        } else {
    ...
    void handle_connect(const boost::system::error_code &err) {
        if (!err) {
            ...
            boost::asio::async_write(socket_, request_,
                                     boost::bind(&HttpClientOld::handle_write_request, this,
                                                 boost::asio::placeholders::error));
        } else {
            std::cout << "Error: " << err.message() << "\n";
        }
    ...
    void handle_write_request(const boost::system::error_code &err) {
        if (!err) {
            ...
            boost::asio::async_read_until(socket_, response_, "\r\n",
                                          boost::bind(&HttpClientOld::handle_read_status_line, this,
                                                      boost::asio::placeholders::error));
        } else {
            std::cout << "Error: " << err.message() << "\n";
        }
    ...
    void handle_read_status_line(const boost::system::error_code &err) {
        if (!err) {
            ...
            boost::asio::async_read_until(socket_, response_, "\r\n\r\n",
                                          boost::bind(&HttpClientOld::handle_read_headers, this,
                                                      boost::asio::placeholders::error));
        } else {
            std::cout << "Error: " << err << "\n";
        }
    ...
    void handle_read_headers(const boost::system::error_code &err) {
        if (!err) {
            ...
            boost::asio::async_read(socket_, response_,
                                    ...
                                    boost::bind(&HttpClientOld::handle_read_content, this,
                                                boost::asio::placeholders::error));
        } else {
            std::cout << "Error: " << err << "\n";
        }
